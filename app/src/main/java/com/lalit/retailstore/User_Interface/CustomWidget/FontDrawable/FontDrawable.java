package com.lalit.retailstore.User_Interface.CustomWidget.FontDrawable;
...
public class FontDrawable extends Drawable {
    ...
    protected FontDrawable(String fontCode, Paint paint, int size, int padding) {
    ...
    public static class Builder {
        ...
        public Builder(Context context, String fontCode, String customFontPath) {
            this(context, fontCode, Typeface.createFromAsset(context.getAssets(), customFontPath));
        }

        public Builder(Context context, String fontCode, Typeface typeface) {
            this(context, fontCode, new CustomFontPaint(typeface));
        }

        public Builder(Context context, String fontCode, CustomFontPaint paint) {
